    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <ul className={styles.contactList}>
              ...
              <li><Mail size={18} /> mariataralunga87@gmail.com</li>
              <li><MapPin size={18} /> STR. REPUBLICII, NR.56, BRAȘOV</li>
            </ul>
      ...
      <div className={styles.bottomBar}>
        <div className="container">
          <p>&copy; {new Date().getFullYear()} KiddyShop - MIRACOLE SRL (CUI 15733484). Toate drepturile rezervate.</p>
        </div>
      </div>
    </footer>
  );
